...
export default function CustomCursor() {
  ...
  return (
    <>
      ...
      />
      <motion.div
        className="fixed top-0 left-0 w-12 h-12 border border-electric-cyan rounded-full pointer-events-none z-50 mix-blend-screen flex items-center justify-center"
        animate={{
